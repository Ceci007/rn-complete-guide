...
const EditProductScreen = (props) => {
  ...
  const [formState, dispatchFormState] = useReducer(formReducer, {inputValues: {
    ...
    imageUrl: editedProduct ? editedProduct.title : "",
    description: editedProduct ? editedProduct.title : "",
    price: editedProduct ? editedProduct.title : "",
  ...
  const submitHandler = useCallback(async () => {
    if(!formState.formIsValid) {
      Alert.alert('wrong input!', 'Please complete your form again', [{text: 'Okay'}])
      return;
    }
    setError(null);
    setIsLoading(true);
